...
def main():
    ...
    run_script("create_temp_feature_tables.py")
    #run_script("populate_temp_feature_tables.py")
    run_script("create_features_table.py")
    run_script("create_clean_features_table.py")
    # run_script("clean_features_table.py")
    run_script("create_enriched_features_table.py")
    # run_script("populate_enriched_features_table.py")
    # run_script("verify_model_features.py")
    run_script("create_model_ready_table.py")
    #run_script("populate_model_ready_table.py")
